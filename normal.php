...
<div id="sidebar" class="span3">
  <ul id="sideManu" class="nav nav-tabs nav-stacked">
    <li class="subMenu open"><a> BRANDS [3]</a>
      <ul>
      <li><a class="active" href="products.html"><i class="icon-chevron-right"></i>BMW </a></li>
      <li><a href="products.html"><i class="icon-chevron-right"></i>Volkswagen</a></li>
      <li><a href="products.html"><i class="icon-chevron-right"></i>Mercedes</a></li>
      </ul>
    </li>
    <li class="subMenu"><a> TYRES [30] </a>
    <ul style="display:none">
      <li><a href="products.html"><i class="icon-chevron-right"></i>Tyre type 1 (45)</a></li>
      <li><a href="products.html"><i class="icon-chevron-right"></i>Tyre type 2 (8)</a></li>
      <li><a href="products.html"><i class="icon-chevron-right"></i>Tyre type 3 (5)</a></li>
    </ul>
    </li>
    <li class="subMenu"><a>ENGINES [30]</a>
      <ul style="display:none">
      <li><a href="products.html"><i class="icon-chevron-right"></i>Engine1 (35)</a></li>
      <li><a href="products.html"><i class="icon-chevron-right"></i>Engine2 (8)</a></li>
    </ul>
    </li>
    <li><a href="products.html">SEAT COVERS [18]</a></li>
  </ul>
  <br/>
    <div class="thumbnail">
